        ...
        <form action={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              name="passcode"
              type="password"
              className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100 outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
              autoComplete="off"
              autoFocus
              required
            />
